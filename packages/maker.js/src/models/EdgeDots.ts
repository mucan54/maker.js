namespace MakerJs.models {
    ...
    export class EdgeDots implements IModel {
        ...
        constructor(rectWidth: number, rectHeight: number, dotDistance: number, scale: number) {
            ...
            this.paths["leftEdge"] = new paths.Circle([scaledDotDistance, scaledHeight / 2], (1.4 / 2) * scale);
            this.paths["rightEdge"] = new paths.Circle([scaledWidth - scaledDotDistance, scaledHeight / 2], (1.4 / 2) * scale);
            this.paths["topEdge"] = new paths.Circle([scaledWidth / 2, scaledDotDistance], (1.4 / 2) * scale);
            this.paths["bottomEdge"] = new paths.Circle([scaledWidth / 2, scaledHeight - scaledDotDistance], (1.4 / 2) * scale);
        }
    }
